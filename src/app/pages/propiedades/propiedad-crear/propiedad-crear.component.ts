		...
		if (this.propId) {
			if (this.propId !== 'nuevo') {
				...
				this.propiedad = {
					...
					piso: 0,
					depto: '',
					tipoinmueble: { nombre: '', id: '' },
					tipounidad: { nombre: '', id: '' },
					tipooperacion: { nombre: '', id: '' },
					...
					aptocredito: false,
					provincia: { nombre: 'Ciudad de Buenos Aires', code: '' },
					departamento: { nombre: 'Comuna 10', code: '' },
					localidad: { nombre: '', code: '', id: '' },
					coords: { lat: '', lng: '' },
					codigopostal: '1417'
				};
